...
public class AddMeal extends AppCompatActivity {
    ...
    private Meal virtualMeal;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_meal_2);

        // get data
        user = (User) getIntent().getSerializableExtra("user");
        virtualMeal = new Meal("test", "test", 0);
        ...
        mealAdapter = new MealAdapter(this, R.layout.meal_list_view, user.getAllMeals());
        ...
        if (updateStatus) {
            ...
            if (editTextValidation()) {
                if (user.getMealByName(mealName.getText().toString()) == null) {
                    ...
                    if (user.addMealToCurrentDiet(newMeal)) {
    ...
    public void selectItem(View v) {
        ...
        itemAdapter = new ItemAdapter(this, R.layout.item_list_view, user.getAllItems());
        ...
        builderSingle.setAdapter(itemAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builderInner.setMessage(user.getAllItems().get(which).getItemName());
